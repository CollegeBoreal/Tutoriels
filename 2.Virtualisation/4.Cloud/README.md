...
Systems can be deployed in `units` ranging from 100kW - 600kW for village power ranging up to <b><u>5 MW</u></b>, and with `larger units` of 350 kW to 1.5 MW for `utility-scale` projects ranging up to `500 MW`.
