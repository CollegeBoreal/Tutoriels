...
var PageRouterOutlet = (function () {
    function PageRouterOutlet(parentOutletMap, containerRef, name, locationStrategy, componentFactoryResolver, compiler, frame, device) {
        var _this = this;
    ...
    PageRouterOutlet.prototype.destroyCacheItem = function (popedItem) {
        if (lang_1.isPresent(popedItem.componentRef)) {
     ...
     */
    PageRouterOutlet.prototype.activate = function (activatedRoute, providers, outletMap) {
    ...
    PageRouterOutlet = __decorate([
        ...
        __metadata('design:paramtypes', [router_1.RouterOutletMap, core_1.ViewContainerRef, String, ns_location_strategy_1.NSLocationStrategy, core_1.ComponentFactoryResolver, core_1.ComponentResolver, frame_1.Frame, Object])
    ], PageRouterOutlet);
